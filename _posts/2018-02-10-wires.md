...
{% include media.html 
    ...
    alt="Screenshot Wires application" 
    caption="Wires is a prototyping application for Internet of Things projects. It allows to connect screen designs with hardware to create combined prototypes." %}
